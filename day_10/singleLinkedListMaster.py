...
while True:
    ...
    print("4. Insert an empty list / Insert in beginning of the list")
    print("5. Insert a node in end of the list")
    print("6. Insert a node after a specified node")
    print("7. Insert a node before a specified node")
    print("8. Insert a node at a giving position")
    ...
    if option == 1:
        ...
        data = int(input("Enter the element to serached : "))
        list.search(data)
    elif option == 4:
        ...
        data = int(
            input("Enter the element at wihic cycle has to be inserted : "))
